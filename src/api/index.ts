...
export const atualizarUsuario = async (id: string, dados:  Partial<{ orcamentoDiario: number }>): Promise<IUsuario> => {
...
export const criarTransacao = async (
    ...
    const novoOrcamentoDiario = usuario.renda + (usuario.renda / 30) + saldo;
